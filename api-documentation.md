...
3. **Membership Roles and Clubs**: Roles requiring club affiliation link to specific clubs
4. **Teams and Profiles**: Profiles join teams through their active club affiliations
5. **Credentials and Roles**: Different roles require different credentials
6. **Suspensions and Roles**: Suspensions can be global or role-specific
